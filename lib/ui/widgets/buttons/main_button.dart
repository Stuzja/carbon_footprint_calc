...
class MainButton extends StatefulWidget {
  ...
  MainButton({
    ...
    double? textSize,
       ...
       _padding = EdgeInsets.only(top: 14.h, bottom: 14.h),
       _textSize = textSize ?? 14.sp,
       _hoverColor =
           hoverColor ?? _calculateHoverColor(backgroundColor ?? inactiveColor);
  ...
  MainButton.small({
    ...
    double? textSize,
       ...
       _padding =
           padding ?? EdgeInsets.symmetric(vertical: 12.h, horizontal: 52.5.w),
  ...
  MainButton.transparent({
    ...
    EdgeInsets? padding,
       ...
       _padding = padding ?? EdgeInsets.only(top: 14.h, bottom: 14.h),
       _textSize = 14.sp,
       _hoverColor =
           hoverColor ?? _calculateHoverColor(backgroundColor ?? inactiveColor);
        ...
        child: Material(
          ...
          child: Theme(
            ...
            child: InkWell(
              ...
              child:
                  widget._isNarrow
                      ? IntrinsicWidth(child: _buildTextAndIcon())
                      : _buildTextAndIcon(),
            ),
          ),
        ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (widget.icon != null && !widget.iconOnLeft!)
            Padding(padding: EdgeInsets.only(left: 8.w), child: widget.icon),
        ],
      ),
    );
  }
